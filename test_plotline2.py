...
if __name__ == '__main__':
    ...
    #cerebro.addstrategy(TrendLine, usepp1=args.usepp1, plot_on_daily=args.plot_on_daily)
    cerebro.addstrategy(St, usepp1=args.usepp1)
